...
namespace WindowsFormsApplication1
{
    ...
    {
        //棋盘常量
        public const int BL = 19;//一行可以下棋数量
        ...
        public const int B_WHILE_COUNT = 180;
        public const int B_BLACK_COUNT = 181;
        //敌我标识
        public const int BLACK_SIGN = 1;
        public const int WHITE_SIGN = -1;
        public const int SPACE_SIGN = 0;
        public const int NONE_SIGN = -2;
        //棋型标识
